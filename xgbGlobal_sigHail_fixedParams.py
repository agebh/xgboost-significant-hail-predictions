...
def main():
    ...
    threshold_cm = 4.4 # 4.4
    ds_factor_us = 39 # before: 39
    ds_factor_eu = 290 # before: 290
    ...
    def save_shap_global_and_dependence(booster, X_explain, feature_names, plots_dir, stats_dir,
                                        fold, rng_seed=0, max_samples=50000, topk_dependence=8):
    ...
    for ii, (tr_idx, val_idx, te_idx) in enumerate(zip(fold_train, fold_val, fold_test)):
        ...
        fixed_params = {
            ...
            "max_depth": 5,
            "min_child_weight": 2.03664420268309,
            "subsample": 0.8659969709057025,
            "colsample_bytree": 0.7993292420985183,
            "gamma": 3.211147731765535,
            'alpha': 0.02702913013640487,
            'lambda': 0.07361108348241488,
        }
